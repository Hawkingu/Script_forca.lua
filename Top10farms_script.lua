...
background.Image = "https://tr.rbxcdn.com/47e2ef592e2d57f075444ef98a329565/420/420/Image/Png" -- imagem do Cobra Kai
...
for i, info in ipairs(buttonsInfo) do
    ...
    btn.Position = UDim2.new(0.1, 0, 0.05 + (i-1)*0.13, 0)
    btn.Text = info.Name
