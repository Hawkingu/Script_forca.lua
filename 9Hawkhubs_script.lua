...
MainFrame.Size = UDim2.new(0, 300, 0, 300)  -- Tamanho maior inicialmente
...
-- Script para Teleporte (clicar para teleportar)
...
-- Script Auto Dumbell (Farm automático)
