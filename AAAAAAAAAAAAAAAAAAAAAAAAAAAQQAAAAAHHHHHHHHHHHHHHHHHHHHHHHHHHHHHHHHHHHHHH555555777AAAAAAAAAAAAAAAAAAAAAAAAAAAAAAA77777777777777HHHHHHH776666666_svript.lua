...
ScreenGui.IgnoreGuiInset = true -- Para ignorar a barra superior e aparecer onde você quer
ScreenGui.Parent = game:GetService("CoreGui") -- Melhor usar CoreGui para scripts locais
