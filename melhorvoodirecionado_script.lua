...
-- Função para controlar a direção do voo
local function updateFlightDirection()
    -- Usando os controles de movimento para alterar a direção do voo
    -- Você pode personalizar a direção do voo com mais controles de entrada, como teclas ou joystick.
